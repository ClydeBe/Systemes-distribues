...
<body>
    ...
    <section id="localisation">
        <div class="container">
            <div class="middle"> Home > Nom de l'article</div>
        </div>
    </section>
    ...
    <section id="article">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card">
                        <img id="article_image" src="" alt="item" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="item-info">
                        <p class="item-title"></p>
                        <strong>Price : <span class="price"></span></strong> 
                        <ul>
                        ...
                        <p class="text-primary"><i class="fas fa-check"></i> In stock</p>
                        <p>SKU P-7435494964</p>
                        <P>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolorem laudantium, totam rem aperiam eaque ipsa quae ab illo inventore</P>
                        <hr>
                        <button class="btn btn-primary"><i class="far far-shopping-cart"></i>Add to Cart</button>
                    </div>
                </div>
                <div class="card text-center items-details">
                ...
                <!-- <div class="col-lg-2">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><a href="#"><img src="item-15.jpg" class="img-fluid" alt="item">Iphone 12</a></li>
                        <li class="list-group-item"><a href="#"><img src="item-12.jpg" class="img-fluid" alt="item">Iphone 12</a></li>
                        <li class="list-group-item"><a href="#"><img src="item-13.jpg" class="img-fluid" alt="item">Iphone 12</a></li>
                    </ul>
                    </div>
                </div> -->
            </div>
